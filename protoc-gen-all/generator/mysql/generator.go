...
import (
	...
	ddl "github.com/xhayamix/proto-gen-golang/protoc-gen-all/generator/mysql/output/db/ddl/mysql"
	"github.com/xhayamix/proto-gen-golang/protoc-gen-all/generator/mysql/output/pkg/cmd/admin/registry"
	entity "github.com/xhayamix/proto-gen-golang/protoc-gen-all/generator/mysql/output/pkg/domain/entity/mysql"
	domainrepository "github.com/xhayamix/proto-gen-golang/protoc-gen-all/generator/mysql/output/pkg/domain/repository/mysql"
	infrarepository "github.com/xhayamix/proto-gen-golang/protoc-gen-all/generator/mysql/output/pkg/infra/mysql/repository"
...
func (g *generator) Build() ([]core.GenFile, error) {
	...
	for _, file := range g.plugin.Files {
		...
		if file.Proto.GetPackage() != "server.mysql" {
			continue
		}
